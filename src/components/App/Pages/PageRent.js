...
class PagesRent extends React.Component {
  handleDeleteClick = (event) => {
    event.stopPropagation();
    this.props.deletePagesRent(this.props.rent.id);
  }
  handleClick = (event) => {
    event.stopPropagation();
    this.props.getPagesRentInfo(this.props.rent.id);
  }
  render() {
