...
class PagesStatement extends React.Component {
  handleDeleteClick = (event) => {
    event.stopPropagation();
    this.props.deletePagesStatement(this.props.statement.id);
  }
